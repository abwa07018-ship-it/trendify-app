...
class _InboxScreenState extends State<InboxScreen> with SingleTickerProviderStateMixin {
  ...
  static final _notifications = [
    ...
    _NotificationItem(
      avatar: 'L',
      username: 'lina.fx',
      action: 'commented: "This filter is amazing! \u{1F525}"',
      time: '1h ago',
      type: _NType.comment,
    ),
    _NotificationItem(
      avatar: 'A',
      username: 'ali_style',
      action: 'used your Anime filter on their video',
      time: '2h ago',
      type: _NType.mention,
    ),
    _NotificationItem(
    ...
    _NotificationItem(
      avatar: 'H',
      username: 'huda.ai',
      action: 'commented: "How did you get that effect??"',
      time: '5h ago',
      type: _NType.comment,
    ),
    _NotificationItem(
  ...
  static final _messages = [
    _MessageItem(
      avatar: 'S',
      username: 'sara_art',
      lastMessage: 'Hey! Loved your last video \u{1F60D}',
      time: '5m ago',
      unread: true,
    ),
    _MessageItem(
      avatar: 'M',
      username: 'mo_creates',
      lastMessage: 'Want to collab on a duet?',
      time: '1h ago',
      unread: true,
    ),
    _MessageItem(
      avatar: 'L',
      username: 'lina.fx',
      lastMessage: 'Which filter did you use?',
      time: '3h ago',
      unread: false,
    ),
    _MessageItem(
    ...
    _MessageItem(
      avatar: 'Z',
      username: 'zaid_film',
      lastMessage: 'Check out this new style I made',
      time: '2d ago',
      unread: false,
    ),
  ];
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      '${_messages.where((m) => m.unread).length}',
                      style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold),
                    ),
                  ),
                ],
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          subtitle: Text(
            m.lastMessage,
            style: TextStyle(
              color: m.unread ? Colors.white70 : Colors.white38,
              fontSize: 13,
            ),
            maxLines: 1,
          ...
          trailing: Column(
            ...
            children: [
              Text(
                m.time,
                style: TextStyle(
                  color: m.unread ? Colors.pinkAccent : Colors.white30,
                  fontSize: 11,
                ),
              ),
            ],
